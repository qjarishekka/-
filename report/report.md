...
![вопрос 1 1.7](image/55.jpg){#fig:055 width=70%}
...
![Вопрос 1 1.9](image/67.jpg){#fig:067 width=70%}

Здесь правилные ответы были `*.?`  `alexey.*` `*.jpg` (рис. [-@fig:068]).

![ответ вопроса 1 1.9](image/68.jpg){#fig:068 width=70%}

Дальше следующий вопрос, который я ответил был следующим  (рис. [-@fig:069]).

![вопрос 2 1.9 ](image/69.jpg){#fig:069 width=70%}
...
![ответ вопроса 2 1.9 ](image/70.jpg){#fig:070 width=70%}
...
![задача 1 1.9](image/71.jpg){#fig:071 width=70%}
...
![ решение задачи 1 1.9](image/72.jpg){#fig:072 width=70%}
...
![FastQC](image/83.jpg){#fig:083 width=70%}


потом я ответил на вопрос (рис. [-@fig:084]) (рис. [-@fig:001]).


![вопрос 1 2.3](image/84.jpg){#fig:084 width=70%}

![ответ вопроса 1 2.3](image/85.jpg){#fig:085 width=70%}
...
![вопрос 2 2.3 ](image/86.jpg){#fig:086 width=70%}
...
![ответ вопроса 2 2.3 ](image/87.jpg){#fig:087 width=70%}

Потом сразу начинал читать следующую задачу (рис. [-@fig:088]).

![задача 1 2.3](image/88.jpg){#fig:088 width=70%}

Затем я загрузил файл (рис. [-@fig:089]) и распаковал его (рис. [-@fig:090]).

![скачанный файл](image/89.jpg){#fig:089 width=70%}

![распаковка файла ](image/90.jpg){#fig:090 width=70%}

Тогда я открывал его с помощью Fastqc и ответил на вопрос (рис. [-@fig:091]).

![решение задачи 1 2.3 ](image/91.jpg){#fig:091 width=70%}

Потом читал следующий вопрос (рис. [-@fig:092]).

![вопрос 2 2.3](image/92.jpg){#fig:092 width=70%}
...
![решение вопроса 2 2.3](image/93.jpg){#fig:093 width=70%}
...
![вопрос 1 2.4](image/94.jpg){#fig:094 width=70%}
...
![ответ вопроса 2 2.5](image/106.jpg){#fig:106 width=70%}

Сразу я читал следующий вопрос (рис. [-@fig:107 ]).

![вопрос 3 2.5](image/107.jpg){#fig:107 width=70%}

там не было правильный ответ то я выбрал "никак "(рис. [-@fig:108 ]).

![ответ вопроса 3 2.5 ](image/108.jpg){#fig:108 width=70%}

Затем я читал следующий вопрос (рис. [-@fig:109 ]).

![вопрос 4 2.5 ](image/109.jpg){#fig:109 width=70%}
...
![ответ вопроса 4 2.5 ](image/110.jpg){#fig:110 width=70%}

Потом я скачал файл для решения следующего вопроса (рис. [-@fig:111 ]).

![вопрос 5 2.5 ](image/111.jpg){#fig:111 width=70%}

я использовал bowtie2 и в конце концов я получил файл "bowtie.log" (рис. [-@fig:112 ]).

![файл ответа вопроса 5 2.5 ](image/112.jpg){#fig:112 width=70%}

Потом я загрузил файл как ответ (рис. [-@fig:113 ]).

![ответ вопроса 5 2.5 ](image/113.jpg){#fig:113 width=70%}
...
![вопрос 1 2.6 ](image/114.jpg){#fig:114 width=70%}

и ответил его (рис. [-@fig:115 ]).

![ответ вопроса 1 2.6 ](image/115.jpg){#fig:115 width=70%}

Потом я решил следующий вопрос (рис. [-@fig:116 ]) (рис. [-@fig:117 ]).


![вопрос 2 2.6 ](image/116.jpg){#fig:116 width=70%}

![ответ вопроса 2 2.6 ](image/117.jpg){#fig:117 width=70%}


Потом я читал следующий вопрос (рис. [-@fig:118 ]).

![вопрос 3 2.6 ](image/118.jpg){#fig:118 width=70%}
...
![ответ вопроса 3 2.6 ](image/119.jpg){#fig:119 width=70%}


Затем следующий вопрос был этим  (рис. [-@fig:120 ]).

![вопрос 3 2.6 ](image/120.jpg){#fig:120 width=70%}

ctrl+b, x закрывает вкладку тогда правильный ответ был следующим (рис. [-@fig:121 ]).

![ответ вопроса 3 ](image/121.jpg){#fig:121 width=70%}


Теперь я начинал следующий вопрос (рис. [-@fig:122 ]).

![вопрос 4 2.6 ](image/122.jpg){#fig:122 width=70%}

Тогда я выполнил все компинации клавиш и нашел правильный вариант (рис. [-@fig:123 ]).

![ответ вопроса 4 2.6 ](image/123.jpg){#fig:123 width=70%}

Потом я решил следующий вопрос (рис. [-@fig:124 ]) (рис. [-@fig:125 ]).

![вопрос 5 2.6 ](image/124.jpg){#fig:124 width=70%}

![ответ вопроса 5 2.6 ](image/125.jpg){#fig:125 width=70%}
...
![вопрос 1 3.2 ](image/137.jpg){#fig:137 width=70%}

![ответ вопроса 1 3.2 ](image/138.jpg){#fig:138 width=70%}

Потом я читал следующий вопрос (рис. [-@fig:139 ]).

![Вопрос 2 3.2 ](image/139.jpg){#fig:139 width=70%}
...
![решение задачи 1 3.2 ](image/144.jpg){#fig:144 width=70%}
...
тогда я написал код, который сравнивает введенную опцию и печает на экран то что задача хотела.(рис. [-@fig:150 ]).
 ...
 ![ответ задачи ](image/150.jpg){#fig:150 width=70%}

 После просмотра видео я читал 3ий вопрос (рис. [-@fig:151 ]).

![вопрос 3 3.3 ](image/151.jpg){#fig:151 width=70%}
...
![ответ вопроса 3 3.3 ](image/152.jpg){#fig:152 width=70%}


Потом я написал код следуя условия задачи (рис. [-@fig:153 ]) (рис. [-@fig:154 ]).


![задача 2 3.3 ](image/153.jpg){#fig:153 width=70%}

![решение задачи 2 3.3 ](image/154.jpg){#fig:154 width=70%}
...
![вопрос 1 3.4 ](image/155.jpg){#fig:155 width=70%}
...
![ответ вопроса 1 3.4 ](image/156.jpg){#fig:156 width=70%}

Потом я перемещал на следующий вопрос (рис. [-@fig:157 ]).

![вопрос 2 3.4 ](image/157.jpg){#fig:157 width=70%}
...
![ответ вопроса 2 3.4 ](image/158.jpg){#fig:158 width=70%}

Третий вопрос этой части был следующим (рис. [-@fig:159 ]).

![вопрос 3 3.4 ](image/159.jpg){#fig:159 width=70%}
...
![ответ вопроса 3 3.4 ](image/160.jpg){#fig:160 width=70%}

Дальше перемещал на следующий вопрос (рис. [-@fig:161 ]).

![Название ](image/161.jpg){#fig:161 width=70%}

тот код я переписал, чтобы он сам выполнял задачу и получался так (рис. [-@fig:162 ]).

![переписание кода ](image/162.jpg){#fig:162 width=70%}

тогда я запускал его и дал мне ответ который я поставил (рис. [-@fig:163 ]).

![решение вопроса 4 3.4 ](image/163.jpg){#fig:163 width=70%}

потом я написал скрипты выполняющий условия задач (рис. [-@fig:164 ] - [-@fig:167 ] )

![скрип 1 ](image/164.jpg){#fig:164 width=70%}

![ответ 1 ](image/165.jpg){#fig:165 width=70%}

![скрип 2 ](image/166.jpg){#fig:166 width=70%}

![ответ 2 ](image/167.jpg){#fig:167 width=70%}


После этого я получил сертификант и закочил внешний курс (рис. [-@fig:168 ]) (рис. [-@fig:169 ]).
.

![конец курса ](image/168.jpg){#fig:168 width=70%}

![сертификант  ](image/169.jpg){#fig:169 width=70%}
