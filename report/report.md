...
![внешний курс](image/1.jpg){#fig:001 width=70%}
...
![вопрос 1 1.1](image/2.jpg){#fig:002 width=70%}

![ответ 1-ого вопроса 1.1](image/3.jpg){#fig:003 width=70%}
...
![вопрос 2 1.1 ](image/4.jpg){#fig:004 width=70%}

![ответ 2-ого вопроса 1.1](image/5.jpg){#fig:005 width=70%}
...
![Второй шаг первого раздела](image/6.jpg){#fig:006 width=70%}
...
![Вопрос 1 1.2](image/7.jpg){#fig:007 width=70%}

![Ответ второго вопроса 1.2 ](image/8.jpg){#fig:008 width=70%}
...
![Установка линукса](image/9.jpg){#fig:009 width=70%}


Потом отвечал следующий вопрос (рис. [-@fig:010]) (рис. [-@fig:011]).

![Вопрос 2 1.2 ](image/10.jpg){#fig:010 width=70%}

![Ответ на вопрос 2 1.2 ](image/11.jpg){#fig:011 width=70%}


Дальше мне спросили смогли ли я запустить Линукс (рис. [-@fig:012]) (рис. [-@fig:013]).


![вопрос 3 1.2 ](image/12.jpg){#fig:012 width=70%}

![ответ на вопрос 3  1.2 ](image/13.jpg){#fig:013 width=70%}
...
![осваиваем Линукс](image/14.jpg){#fig:014 width=70%}

Дальше в видео показали как запускать Firefox (рис. [-@fig:015]).

![Firefox](image/15.jpg){#fig:015 width=70%}
...
![средство просмотра папок](image/16.jpg){#fig:016 width=70%}
...
![Задача о создании документа 1.3](image/17.jpg){#fig:017 width=70%}
...
![решение задачи 1.3 ](image/18.jpg){#fig:018 width=70%}
...
![Задача 2 1.3 ](image/22.jpg){#fig:022 width=70%}

Я установил программу и смотерть описание программы чтобы знать кто автор и ответил на вопрос (рис. [-@fig:023]).

![решение задачи 2 1.3 ](image/23.jpg){#fig:023 width=70%}

Потом я ответил на следующий вопрос (рис. [-@fig:024]) (рис. [-@fig:025]).

![вопрос 2 1.3 ](image/24.jpg){#fig:024 width=70%}

![Ответ вопроса 2 1.3](image/25.jpg){#fig:025 width=70%}
...
![ответ вопроса 3 1.4 ](image/32.jpg){#fig:032 width=70%}
...
![Комвинации клавиш](image/33.jpg){#fig:033 width=70%}

После того как я смотрел осталные видео я ответил на следующий вопрос (рис. [-@fig:034]).

![вопрос 4 1.4 ](image/34.jpg){#fig:034 width=70%}
...
![запуск firefox](image/38.jpg){#fig:038 width=70%}

Потом я ответил на следующий вопрос (рис. [-@fig:039]) (рис. [-@fig:040]).

![вопрос 1 1.5 ](image/39.jpg){#fig:039 width=70%}

![ответ вопроса 1 1.5](image/40.jpg){#fig:040 width=70%}

Дальше я смотрел видео о пререрыве программ и выполнил то действие в терминале (рис. [-@fig:041]).

![пререрыв программ](image/41.jpg){#fig:041 width=70%}

Потом я читал и ответил на следующий вопрос (рис. [-@fig:042]).

![вопрос 2 1.5](image/42.jpg){#fig:042 width=70%}
...
![вопрос 1 1.6](image/49.jpg){#fig:049 width=70%}

по умолчанию всегда терминал показывает ошибку на экране (рис. [-@fig:050]).

![Ответ вопроса 1 1.6](image/50.jpg){#fig:050 width=70%}
...
![решение задачи 1 3.2 ](image/placeimg_800_600_tech.jpg){#fig:144 width=70%}
...
в этой части я закончил изучение основ программирования на bash. тогда я перемещал на первый вопрос (рис. [-@fig:155 ]).

![вопрос 1 3.4 ](image/placeimg_800_600_tech.jpg){#fig:155 width=70%}

команда let служит для выполнения арифметичеких операций тогда я выбрал ответы которые правильно используют команду (рис. [-@fig:156 ]).

![ответ вопроса 1 3.4 ](image/placeimg_800_600_tech.jpg){#fig:156 width=70%}

Потом я перемещал на следующий вопрос (рис. [-@fig:157 ]).

![вопрос 2 3.4 ](image/placeimg_800_600_tech.jpg){#fig:157 width=70%}

тот код выполняет две команды cd и echo тогда ответ будет только /home/bi, потому что команда echo выполняет комнаду pwd (рис. [-@fig:158 ]).

![ответ вопроса 2 3.4 ](image/placeimg_800_600_tech.jpg){#fig:158 width=70%}

Третий вопрос этой части был следующим (рис. [-@fig:159 ]).

![вопрос 3 3.4 ](image/placeimg_800_600_tech.jpg){#fig:159 width=70%}

для правильного выполнения программы надо написать внутри команды if ту команду, которую мы хотим выполнить или мы можем просто запускать её сначала о потом программу сравнивая ответ первой команды (рис. [-@fig:160 ]).

![ответ вопроса 3 3.4 ](image/placeimg_800_600_tech.jpg){#fig:1 width=70%}

Дальше перемещал на следующий вопрос (рис. [-@fig:161 ]).

![Название ](image/placeimg_800_600_tech.jpg){#fig:161 width=70%}

тот код я переписал, чтобы он сам выполнял задачу и получался так (рис. [-@fig:162 ]).

![переписание кода ](image/placeimg_800_600_tech.jpg){#fig:162 width=70%}

тогда я запускал его и дал мне ответ который я поставил (рис. [-@fig:163 ]).

![решение вопроса 4 3.4 ](image/placeimg_800_600_tech.jpg){#fig:163 width=70%}

потом я написал скрипты выполняющий условия задач (рис. [-@fig:164 ] - [-@fig:167 ] )  

![скрип 1 ](image/placeimg_800_600_tech.jpg){#fig:164 width=70%}

![ответ 1 ](image/placeimg_800_600_tech.jpg){#fig:165 width=70%}

![скрип 2 ](image/placeimg_800_600_tech.jpg){#fig:166 width=70%}

![ответ 2 ](image/placeimg_800_600_tech.jpg){#fig:167 width=70%}


После этого я получил сертификант и закочил внешний курс (рис. [-@fig:168 ]) (рис. [-@fig:169 ]).
.

![конец курса ](image/placeimg_800_600_tech.jpg){#fig:168 width=70%}

![сертификант  ](image/placeimg_800_600_tech.jpg){#fig:169 width=70%}



# Выводы

на этой неделе я пересмотрел все что я делал в течение курса по Архитектуре компьютеров. я смог выучить как перемещать с помощью терминала, создать скрипты и работать в сервере через терминал в Linux и все научено здесь я могу использовать в будущее время.
